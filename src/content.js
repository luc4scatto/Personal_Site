...
export const content = {
  ...
  skills: {
    blender: { title: 'Blender', text: 'Placeholder - what I actually do with Blender goes here.', color: '#E87D0D', selfTaught: true },
    ...
    'nvidia-omniverse': { title: 'NVIDIA Omniverse', text: 'Placeholder - what I actually do with Omniverse goes here.', color: '#76B900', selfTaught: true },
    'unreal-engine': { title: 'Unreal Engine', text: 'Placeholder - what I actually do with Unreal Engine goes here.', color: '#FFFFFF' },
    touchdesigner: { title: 'TouchDesigner', text: 'Placeholder - what I actually do with TouchDesigner goes here.', color: '#707D51', selfTaught: true },
    'after-effects': { title: 'After Effects', text: 'Placeholder - what I actually do with After Effects goes here.', color: '#9999FF', selfTaught: true },
    ...
    python: { title: 'Python', text: 'Placeholder - what I actually do with Python goes here.', color: '#3776AB', selfTaught: true },
    'qt-designer': { title: 'Qt Designer', text: 'Placeholder - what I actually do with Qt Designer goes here.', color: '#41CD52', selfTaught: true },
    ...
    comfyui: { title: 'ComfyUI', text: 'Placeholder - what I actually do with ComfyUI goes here.', color: '#B4EC17' },
  },
};
