...
export const content = {
  ...
  skills: {
    ...
    'nvidia-omniverse': {
      ...
      color: '#76B900',
      selfTaught: true,
      bullets: ['Automation and Extensions', 'Rendering', 'MTLX, OpenPBR Shading', 'Manage USD complex files'],
    },
    ...
    touchdesigner: {
      ...
      color: '#707D51',
      selfTaught: true,
      bullets: ['Audio-reactive Visuals', 'Connection between TD and other DCCs', 'External controller connection', 'Scripting', '3D Scenes'],
    },
    'after-effects': {
      title: 'After Effects',
    ...
    'premiere-pro': {
      ...
      color: '#9999FF',
      bullets: ['Video Editing', 'Color Balance', 'Color Correction'],
    },
